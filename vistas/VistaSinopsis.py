from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QLabel, QPushButton, QTextEdit, QGridLayout, QScrollArea
...
class VistaSinopsis(QMainWindow):
    ...
    def onFinished(self, reply):
        ...
        """
        button = self.active_requests.pop(reply, None)  # Obtener el botón asociado
        if button:
